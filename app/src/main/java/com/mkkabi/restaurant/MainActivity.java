...
import com.mkkabi.restaurant.ui.restaurants.StravaListFragment;
...
//        });
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_restaurants, R.id.nav_account_login_firebase)
        ...
        msg.retrieveCurrentToken();


        msg.getNotificationExtras(getIntent());


//        msg.sendNotification("test notification form MainActivity");
